...
export const SpecialOfferCard = ({
    ...
    return (
        <div
            ...
            className="group relative w-full h-[300px] rounded-[24px] overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.4)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.6)] transition-all duration-300 hover:-translate-y-1 bg-gradient-to-b from-slate-800 to-slate-900 cursor-pointer"
            role="button"
            tabIndex={0}
            onKeyDown={(e) => {
